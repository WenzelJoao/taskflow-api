...
export type GetProjetoAggregateType<T extends ProjetoAggregateArgs> = {
    [P in keyof T & keyof AggregateProjeto]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateProjeto[P]> : Prisma.GetScalarType<T[P], AggregateProjeto[P]>;
};
...
export type GetProjetoGroupByPayload<T extends ProjetoGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ProjetoGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ProjetoGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ProjetoGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ProjetoGroupByOutputType[P]>;
}>>;
...
export type ProjetoScalarWhereWithAggregatesInput = {
    ...
    data_criacao?: Prisma.DateTimeWithAggregatesFilter<"Projeto"> | Date | string;
    data_vencimento?: Prisma.DateTimeWithAggregatesFilter<"Projeto"> | Date | string;
...
export type ProjetoUpdateOneWithoutTarefasNestedInput = {
    create?: Prisma.XOR<Prisma.ProjetoCreateWithoutTarefasInput, Prisma.ProjetoUncheckedCreateWithoutTarefasInput>;
    connectOrCreate?: Prisma.ProjetoCreateOrConnectWithoutTarefasInput;
...
export type ProjetoCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ProjetoFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ProjetoDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * })
    **/
    count<T extends ProjetoCountArgs>(args?: Prisma.Subset<T, ProjetoCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ProjetoCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ProjetoGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ProjetoGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetProjetoGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface ProjetoFieldRefs {
    ...
    readonly data_criacao: Prisma.FieldRef<"Projeto", 'DateTime'>;
    readonly data_vencimento: Prisma.FieldRef<"Projeto", 'DateTime'>;
...
//# sourceMappingURL=Projeto.d.ts.map